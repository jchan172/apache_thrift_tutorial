...
class AddressbookHandler:
  ...
  def serialize(self, msg):
    ...
    protocolOut = TCompactProtocol.TCompactProtocol(transportOut) # Alternatively, use binary protocol: protocolOut = TBinaryProtocol.TBinaryProtocol(transportOut)
  ...
  def deserialize(self, msg, data):
    ...
    protocol_in = TCompactProtocol.TCompactProtocol(transport_in) # Alternatively, use binary protocol: protocol_in = TBinaryProtocol.TBinaryProtocol(transport_in)
  ...
  def listAll(self, filename):
   ...
   # Read the existing address book.  
    ...
    # Deserialize address book and load contents into 'contacts' variable.
